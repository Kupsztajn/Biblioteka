...
SMTP_PORT = 587
EMAIL_USER = 'wpisz swojego maila z ktorego bedziesz wysylac przypomnienia'       # Twój email do logowania na SMTP
EMAIL_PASS = 'twoj kod aplikacji do twoje maila ( NIE WPISUJ SWOJEGO HASLA DO MAILA)'             # Hasło aplikacji SMTP
